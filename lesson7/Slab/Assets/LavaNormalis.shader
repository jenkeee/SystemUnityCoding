...
// хочу чтоб зеленым мерцала как малакор, вот его ргб 44,104,35
// преобразуем это к единицам If x = 95 then your value is 95/255 = 0.373 (to 3 d.p.)
fixed4 col = lerp(ice,float4(0.173,0.408,0.173,1)*(_SinTime.w*4+_CosTime.x),length(norm.xy)*_Str);
